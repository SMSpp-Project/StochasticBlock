 ...
 * general one where the random variables depend on the entire previous history.
 * The interfaces strives to avoid to distinguish those cases by having each
 * stage x_t generated / read only when its history H_t is clearly specified,
