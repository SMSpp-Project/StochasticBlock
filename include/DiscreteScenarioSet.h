 ...
 */
 ...
 /** @return true if init_random_pool() or init_representative_pool() has been
  * called */
 ...
 [[nodiscard]] ScenarioIndex get_poolSize( void ) const { return(poolSize); }
 ...
 [[nodiscard]] inline std::span< const double > get_pool_weights( void ) const {
  if( ! is_initialized )
